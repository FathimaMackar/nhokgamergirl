...
<div class="nk-fullscreen-block">
    ...
    <div class="nk-fullscreen-block-middle">
        <div class="container text-center">
            <h1 class="h3"> <p style="  font-family:Dubai:;  font-size:40px; color:  #f0543c"> Coming Soon</h1> </p>
    ...
    <div class="nk-fullscreen-block-bottom">
        ...
        <ul class="nk-social-links-2 nk-social-links-center">
             <li><a class="nk-social-instagram" href="https://instagram.com/nhok_girlgamer?utm_medium=copy_link"><span class="fab fa-instagram"></span></a></li>
            <li><a class="nk-social-youtube" href="https://www.youtube.com/channel/UCk2RJSZGpD9xo7Vdhz5syAg"><span class="fab fa-youtube"></span></a></li>
 ...
 -->
    ...
    <div class="nk-page-background-fixed" style="  filter: blur(8px);
  -webkit-filter: blur(8px); background-image: url('assets/images/bg-fixed-1.jpg');"></div>
